...
import { PricingCards } from "@/components/pricing-tiers";
    ...
    <div className="min-h-dvh flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section id="pricing" className="max-w-5xl mx-auto px-6 md:px-10 py-14 border-t border-line">
          ...
          <PricingCards showBenefitsLinks />
          <p className="text-xs text-ink-2 mt-4 text-center">Secure payments by Paddle. Prices in USD. <Link href="/pricing" className="underline underline-offset-2">Full feature comparison →</Link></p>
        </section>
